    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="<?=site_url('dashboard'); ?>" class="d-lg-none">
                <img alt="Logo" src="<?=base_url() ?>assets/media/logos/nobg-logo.png" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div  class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 fw-semibold my-5 my-lg-0 px-2 px-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <span class=" py-3">
                                <h1><?=$this->setting->getValue('app_name','Veren Association Ghana'); ?></h1>
                            </span>
                            <!--end:Menu link-->
                        </div>
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="<?=$this->user->urlToAvatar($this->auth->getAvatar()) ?>" alt="image" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="<?=$this->user->urlToAvatar($this->auth->getAvatar()) ?>" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?=$this->auth->getUserName()?$this->auth->getUserName():'<a href="#">Set Name</a>'; ?>
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?=$this->auth->getRole()->title; ?></span>
                                    </div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?php
                                    
                                    if($this->auth->getMembership()){
                                        if($this->auth->getMembership()->verified === 'yes')
                                            echo $this->auth->getMembership()->memberId;
                                     } ?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        ...
                        <div class="menu-item px-5">
                            ...
                            <?php if($this->auth->getMembership()){ ?>
                            <a href="<?=site_url('members/view/'.$this->auth->getMembership()->id) ?>?page=overview" class="menu-link px-5">My Membership Profile</a>
                            <?php } ?>
                        </div>
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="<?=site_url('users/view/'.$this->auth->getUserId()) ?>?page=settings" class="menu-link px-5">Account Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">

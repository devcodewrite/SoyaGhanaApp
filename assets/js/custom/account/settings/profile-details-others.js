...
// Class definition
var KTAccountSettingsProfileDetailsOthers = function () {
    // Private variables
    var form;
    var submitButton;
    var validation;
    ...
    return {
        init: function () {
            form = document.getElementById('kt_account_profile_details_others_form');
            
            if (!form) {
                return;
            }

            submitButton = form.querySelector('#kt_account_profile_details_others_submit');
...
KTUtil.onDOMContentLoaded(function() {
    KTAccountSettingsProfileDetailsOthers.init();
});

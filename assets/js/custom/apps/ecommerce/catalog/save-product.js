...
var KTAppEcommerceSaveProduct = function () {
    ...
    const initDropzone = () => {
        var myDropzone = new Dropzone("#kt_ecommerce_add_product_media", {
            url: "catalogs/upload-media", // Set the url for your upload script location
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        formData.append('description',  $("#kt_ecommerce_add_product_description").text());
                        $.ajax({
                            url:  form.getAttribute("data-kt-redirect"),
                            type: "POST",
                            data: formData,
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            if(typeof d.data.id === 'undefined'){
                                                $("input,textarea").val('');
                                                $("#kt_ecommerce_add_product_description").text('');
                                            }
                                        }
                                    });

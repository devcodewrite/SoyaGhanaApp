					...
					render: function (data, type, row) {
						...
						if (type === "display") {
							d =
								...
								'<div class="menu-item px-3"><a href="#" data-id="'+data+'" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">Delete</a>' +
								"</div></div>";
						}
						return d;
					},
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
					...
					url: "catalogs",
					type: "POST",
					data: { id: $(d).data('id'), action: "delete" },
					dataType: "json",
					...
					error: function (s) {
						Swal.fire({
							text: "Sorry, Record couldn't be deleted! Please try agian!",
							icon: "error",
							buttonsStyling: false,
							confirmButtonText: "Ok, got it!",
							customClass: {

...
var KTCustomersList = (function () {
	...
	var initCustomerList = function () {
		...
		datatable = $(table).DataTable({
			ajax: {
				url: "../datatable-json/registrations",
				data: function (d) {},
			},
			columns: [
				{
					...
					render: function (data, type, row) {
						...
						if (type === "display") {
							d =
								...
								'<div class="menu-item px-3"><span onclick="verifyMRequest(this,' +
								data +
								')" class="menu-link px-3">Verify</span></div>' +
								'<div class="menu-item px-3"><a href="edit/' +
								data +
